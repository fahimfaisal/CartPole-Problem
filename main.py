...
original source: https://github.com/JoeSnow7/Reinforcement-Learning/blob/master/Cartpole%20Q-learning.ipynb
"""

class CartPoleQAgent():
    def __init__(self, buckets=(3, 3, 6, 6),
                 num_episodes=1000, min_lr=0.1,
    ...
    def train(self):
        ...
        agent is trained by default for 1000 episodes with a declining
    ...
    def random(self):
        ...
        for i_episode in range(EPISODES):
            ...
            for t in range(1000):
                ...
                env.render()
                action = env.action_space.sample()  # We take a random action
        ...
        print('avg time step network survives : ', avg_time)
